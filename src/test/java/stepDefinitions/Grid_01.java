...
public class Grid_01 {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.100.219:4444"), new ChromeOptions());
    ...
    void firefoxTest() throws MalformedURLException {
        ...
        driver = new RemoteWebDriver(new URL("http://192.168.100.219:4444"), new FirefoxOptions());
