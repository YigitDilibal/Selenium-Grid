...
public class GridDriverMethods {
    ...
    public WebDriver setUpChromeDriver(){
        ...
        capabilities.setVersion("133.0.6943.98");
    ...
    public WebDriver setUpFirefoxTest(){
        ...
        try {
            driver = new RemoteWebDriver(new URL("http://192.168.100.219:4444"), firefoxOptions);
        } catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
    ...
    public WebDriver setUpEdgeTest() {
        ...
        try {
            driver = new RemoteWebDriver(new URL("http://192.168.100.219:4444"), edgeOptions);
        } catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
